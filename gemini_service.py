...
น้องไอ: ยินดีต้อนรับค่ะ 😊 ห้องพักเรามี Superior เริ่มต้น 750 บ. และ Deluxe (รวมอาหารเช้าบุฟเฟต์) 1,000 บ. ค่ะ วางแผนเข้าพักวันไหน พักกี่ท่านคะ? เช็คห้องว่างจองทาง LINE OA: @ihotelkk ได้เลยนะคะ 👉 https://line.me/R/ti/p/@ihotelkk ✨
