...
HOTEL_INFO = {
    ...
    "location": {
        ...
        "nearby_places": [
            "เทสโก้ โลตัส โนนม่วง (โลตัส ขอนแก่น 3): อยู่ใกล้โรงแรมเพียง 1-2 นาที (~500 ม.) (แผนที่: https://maps.app.goo.gl/eZ231QLWHQ8kCzFn9)",
            "มหาวิทยาลัยขอนแก่น (มข.): เดินทางประมาณ 5-10 นาที (~3-4 กม.)",
            "โรงพยาบาลศรีนครินทร์: เดินทางประมาณ 8-10 นาที (~4-5 กม.)",
            "เซ็นทรัล แคมปัส (Central Campus): เดินทางประมาณ 5-7 นาที (~3-4 กม.)",
            "เซ็นทรัลพลาซา ขอนแก่น (Central Khon Kaen): เดินทางประมาณ 12-15 นาที (~7-8 กม.)",
            "สนามบินนานาชาติขอนแก่น: เดินทางประมาณ 15-20 นาที (~10-12 กม.)"
        ],
        "distances": {
            "lotus": "โลตัส โนนม่วง (ขอนแก่น 3): 1-2 นาที (~500 ม.)",
            "kku": "มหาวิทยาลัยขอนแก่น (มข.): 5-10 นาที (~3-4 กม.)",
            "srinagarind": "โรงพยาบาลศรีนครินทร์: 8-10 นาที (~4-5 กม.)",
            "central_campus": "เซ็นทรัล แคมปัส (Central Campus): 5-7 นาที (~3-4 กม.)",
            "central_khonkaen": "เซ็นทรัลพลาซา ขอนแก่น: 12-15 นาที (~7-8 กม.)",
            "airport": "สนามบินนานาชาติขอนแก่น: 15-20 นาที (~10-12 กม.)"
        }
    },
    ...
    "faqs": [
        {
            "question": "อาหารเช้าให้บริการกี่โมง มีอะไรบ้าง ราคาเท่าไหร่?",
            "answer": "อาหารเช้าบุฟเฟต์ให้บริการเวลา 06:30 - 10:00 น. ค่ะ มีขนมปัง น้ำผลไม้ อาหารไทยตามฤดูกาล สลัดบาร์ เมนูทอดร้อนๆ เช่น ไข่กระทะ กาแฟสด\n- ห้อง Deluxe และ Grand Deluxe รวมฟรี\n- ห้อง Superior ซื้อเพิ่มพร้อมห้อง 100 บาท/ท่าน (ซื้อหลังจอง 120 บาท/ท่าน)"
        },
        {
            "question": "โรงแรมอยู่ห่างจาก มข. / รพ.ศรีนครินทร์ / เซ็นทรัล / สนามบิน เท่าไหร่?",
            "answer": "ระยะทางและการเดินทางจากโรงแรมค่ะ 🚗✨\n• โลตัส โนนม่วง: 1-2 นาที (~500 ม.)\n• มหาวิทยาลัยขอนแก่น (มข.): 5-10 นาที (~3-4 กม.)\n• โรงพยาบาลศรีนครินทร์: 8-10 นาที (~4-5 กม.)\n• เซ็นทรัล แคมปัส (Central Campus): 5-7 นาที (~3-4 กม.)\n• เซ็นทรัลพลาซา ขอนแก่น: 12-15 นาที (~7-8 กม.)\n• สนามบินนานาชาติขอนแก่น: 15-20 นาที (~10-12 กม.)\n📍 แผนที่: https://maps.app.goo.gl/E6sbBJwRwNMSm4cB7"
        },
        {
        ...
        },
        {
            ...
            "answer": "การจองห้องพักทุกประเภท ลูกค้าจะต้องจองผ่าน LINE OA: @ihotelkk เท่านั้นค่ะ (คลิก: https://line.me/R/ti/p/@ihotelkk) สะดวกรวดเร็วและเช็คห้องว่างได้ทันทีค่ะ ✨"
        },
        {
...
ที่ตั้งและระยะทางไปยังสถานที่สำคัญ:
...
- LINE OA สำหรับจองห้องพัก: {HOTEL_INFO['contact']['line_oa']} (https://line.me/R/ti/p/@ihotelkk)

ข้อมูลอาหารเช้าแบบบุฟเฟต์ (Buffet Breakfast):
- เวลาให้บริการ: {HOTEL_INFO['breakfast_info']['service_time']} (6:30 - 10:00 น.)
- รายการอาหาร: ขนมปัง, น้ำผลไม้, อาหารไทยตามฤดูกาล, สลัดบาร์, เมนูทอดร้อนๆ เช่น ไข่กระทะ ไส้กรอก แฮม, กาแฟสด, อาหารพิเศษประจำวัน
...
นโยบายและเวลาทำการ:
- จองห้องพัก: จองผ่าน LINE OA: @ihotelkk เท่านั้น
